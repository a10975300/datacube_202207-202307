    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ProductPhase', models.CharField(blank=True, choices=[('SI-1', 'SI-1'), ('SI-2', 'SI-2'), ('SI-3', 'SI-3'), ('PV-1', 'PV-1'), ('PV-2', 'PV-2'), ('PV-3', 'PV-3'), ('PRB/TLD/PVR', 'PRB/TLD/PVR'), ('MV-1', 'MV-1'), ('MV-2', 'MV-2'), ('Ramp', 'Ramp'), ('Production', 'Production')], max_length=10, null=True, verbose_name='Current Stage')),
                ...
                ('BuildDate_SI', models.DateField(blank=True, null=True, verbose_name='SI Date')),
                ('BuildDate_PV', models.DateField(blank=True, null=True, verbose_name='PV Date')),
                ('BuildDate_MV', models.DateField(blank=True, null=True, verbose_name='MV Date')),
                ('RTP', models.DateField(blank=True, null=True, verbose_name='RTP Date')),
                ...
                ('Product_MV_date', models.DateField(blank=True, null=True, verbose_name='Year')),
