...
class Products(models.Model):
    ...
    ProductPhase = models.CharField(null=True,  blank=True, choices=PHASE,verbose_name="Current Stage", max_length=15)
    ...
    Product_Segment = models.CharField(choices=SEGMENT, blank=True, max_length=20, verbose_name="Segment")
    ...
    Product_MV_date = models.DateField(null=True, blank=True, verbose_name="Year")
