...
class Dfa_Review_Result(models.Model):
    ...
    packing_designs_kitting_box_design = (
        ("IMPACT", "IMPACT"),
    )
    packing_designs = (
        ("IMPACT", "IMPACT"),
    )
    equipment_facilites_UPH_concerns = (
        ("IMPACT", "IMPACT"),
    )
    ...
    dfa_production_line = models.CharField(null=True, blank=True,choices=production_line, max_length=50, verbose_name="PL")
    dfa_cnc = models.CharField(null=True, blank=True, choices=cnc, max_length=50, verbose_name="CNC")
    dfa_si_pv = models.CharField(null=True, blank=True, choices=si_pv, max_length=50, verbose_name="SI-PV")
    dfa_mv_mp = models.CharField(null=True, blank=True, choices=mv_mp, max_length=50, verbose_name="MV-MP")
    dfa_HP_commodities_design = models.CharField(null=True, blank=True, choices=commodities_design, max_length=50, verbose_name="CMDT_design_HP")
    dfa_odm_product_designs = models.CharField(null=True, blank=True, choices=product_designs, max_length=50, verbose_name="Product_design_ODM")
    dfa_odm_packing_designs_kitting_box_design = models.CharField(null=True, choices=packing_designs_kitting_box_design, blank=True, max_length=50, verbose_name="PACK_BOX_design_ODM")
    dfa_HP_packing_designs = models.CharField(null=True, blank=True, choices=packing_designs, max_length=50, verbose_name="PACK_design_HP")
    dfa_equipment_facilites_UPH_concerns = models.CharField(null=True, blank=True, choices=equipment_facilites_UPH_concerns, max_length=50, verbose_name="EQT/FAC/UPH concern")
    ...
    dfa_pictures_from_factory = models.CharField(null=True, blank=True,choices=pictures_from_factory, max_length=50,verbose_name="PIC")
    dfa_HP_internal_discussion = models.CharField(null=True, blank=True, max_length=50, verbose_name="INTL_CMT_HP")
    dfa_HP_internal_assessment = models.CharField(null=True, blank=True, choices=internal_assessment, max_length=50, verbose_name="INTL_ASS_HP")
