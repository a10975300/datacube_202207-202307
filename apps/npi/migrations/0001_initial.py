...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('processName', models.CharField(choices=[('1-SMT', 'SMT'), ('2-Off-line Assy', 'Offline-Assy'), ('3-Sub Assy Test', 'Offline-Test'), ('4-Final Assy ', 'FA'), ('5-Pre Test', 'Pre-Test'), ('6-Run-In', 'Run-In'), ('7-Image Download', 'Image D/L'), ('8-OOBA ', 'OOBA'), ('9-Packing ', 'Packing'), ('Field', 'Field')], max_length=50, verbose_name='Issue is from')),
